    ...
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <table class="table" style="max-width: 400px;">
                ...
                <tr>
                    <th>Database ID</th>
                    <td>{{$schema['table']['original']['table_id']}}</td>
                </tr>
                <tr>
                    <th>Creation Date</th>
                    <td>{{$schema['table']['original']['cre_date']}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>Next Record ID</th>
                    <td>{{$schema['table']['original']['next_record_id']}}</td>
                </tr>
                </tbody>
            </table>
            <hr>
